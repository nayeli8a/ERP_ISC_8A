	    ...
	    <div class="modal-content">
	      ...
	      <form action="${pageContext.servletContext.contextPath}/Registrar?op=Estado" method="post">
			<div class="form-group">
				<label>Nombre: </label>
				<input type="text" onkeypress="return soloLetras(event)" class="form-control"  id="nom_estado" name="nom_estado" required>
				<br>
				<label>Siglas: </label>
				<input type="text" onkeypress="return soloLetras(event)" class="form-control" id="siglas" name="siglas" required>
				<br>
