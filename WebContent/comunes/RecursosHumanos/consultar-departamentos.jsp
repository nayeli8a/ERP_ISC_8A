...
<body>
				...
				<tbody id="myTable">
					<c:forEach var="dato" items="${datos}">
						...
						<c:if test="${dato.getEstatus() eq 'A'}">
							...
							<td>${dato.getEstatus()}</td>
							<td>
								<form id="formulario" action="Departamentos" method="post">
									<input type="hidden" name="id" value="${dato.getIdDepartamento()}">
									<div id="${dato.getIdDepartamento()}">
	  ...
	  <div class="modal-dialog modal-lg">
	    <div class="modal-content">
	      ...
	      <div class="modal-header">
	        <h4 class="modal-title">Registro de Departamentos</h4>
	...
	<nav aria-label="paginacion departamentos">
	  <ul class="pagination justify-content-center">
	    <c:if test="${pagina eq 1}">
	    	<li class="page-item disabled">
		      <a class="page-link" href="${pageContext.servletContext.contextPath}/Departamentos?op=Listar&pagina=${pagina-1}">Previous</a>
		    </li>
	    </c:if>
	    <c:if test="${pagina > 1}">
	    	<li class="page-items">
	    ...
	    <li class="page-item">
	      <a class="page-link" href="${pageContext.servletContext.contextPath}/Departamentos?op=Listar&pagina=${pagina+1}">Next</a>
	    </li>
	  </ul>
	</nav>
