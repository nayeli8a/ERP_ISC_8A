  ...
  <p class="bg-primary text-white">EDITAR PUESTOS</p>
		...
		<form action="${pageContext.servletContext.contextPath}/Puestos?op=Modificar" method="post">
			<div class="form-group">
				...
				<br>
				<label>Nombre :</label>
				<input type="text" onkeypress="return soloLetras(event)" class="form-control" id="nom_puestos" name="nom_puestos"  required value="${datospuestos.getNombre()}">
				<br>
				
				<label>Salario Minimo :</label>
				<input type="number" class="form-control" id="salarioMinimo" name="salarioMinimo" required min="100.0" onkeypress="if ( isNaN( String.fromCharCode(event.keyCode) )) return false;" value="${datospuestos.getSalarioMinimo()}">
				<br>
				
				<label>Salario Maximo:</label>
				<input type="number" class="form-control" id="salarioMaximo" name="salarioMaximo" required onkeypress="if ( isNaN( String.fromCharCode(event.keyCode) )) return false;"value="${datospuestos.getSalarioMaximo()}">
				<br>
