...
<body onkeypress="return soloLetras(event)">
	...
	<div class="card bg-light" style="margin-top: 100px">
		...
		<p class="bg-primary text-white">EDITAR FORMAS DE PAGO</p>

		<form
			action="${pageContext.servletContext.contextPath}/FormasPago?op=Modificar"
			method="post">
			<div class="form-group">
				...
				<div class="row">
					<div class="col-md-2">
						<div class="form-group">
							<label>ID:</label> <input type="texto" name="idFormaPago"
								class="form-control" value="${datosformaspago.getIdFormaPago()}"
								readonly>
						</div>
					</div>
					...
					<div class="col-md-2">
						<div class="form-group">
							<label>Nombre:</label> <input type="text" name="nombre"
								...
								value="${datosformaspago.getNombre()}"> <br>
						</div>
					</div>
